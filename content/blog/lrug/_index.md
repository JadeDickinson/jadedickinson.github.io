...
### Be in the right mindset whether you’re managing your search or executing on it

It is very important to make a schedule \- I’ll take about this later. You want a clean division between managing a job search and executing on it.

One of the first things I did was to find all the meetups I want to go to. From these you can get a great deal of support and learning. My personal favourites were LRUG, [WNB.rb](https://www.wnb-rb.dev/), London Gophers, Thoughtbot and [incident.io](http://incident.io) events.

Outside of prep it is nice to build something that feels more like real work. So if you have any hobby projects you've enjoyed in the past, pick them back up, it will really help \- for example I have a Tesco chrome extension that sorts products by price per unit. I logged back into the email I have for it, had an email from someone saying it had stopped working, Tesco did another update, so I said cool, I'll fix it. That feels really nice.
...
I used Gergely Orosz' resume template: [https://blog.pragmaticengineer.com/the-pragmatic-engineers-resume-template](https://blog.pragmaticengineer.com/the-pragmatic-engineers-resume-template) 

A good CV point is an action word, a good one will quantify what the business impact of the work was. You don't always know that but if you can put that in there, please do.

I would advise to write concisely and to avoid LLMs \- unless you have always sounded like an LLM \- they tend to write prose in a fairly detectable way. So I don't think it really highlights if you have a genuine interest and investment in a role.

Early on I tailored each CV a lot to each role. Later down the line I found I had a couple of types of CV that worked best for different types of role. For example having a lot of fintech experience, focusing on that made a lot of sense for fintech roles, but not for others.

You can also look at structural edits like reordering. So if a job description is highlighting something and it's buried way down in each job, just bring it up to the top.
...
To find the roles that recruiters are not sending you - this was very effective - I used Andy Croll’s site [https://usingrails.com/](https://usingrails.com/). You can filter by country, and then, if you like, you can go on every single company in that country, go on that job site and see if they are or are not hiring, because not every company that is hiring is going to use recruiters.

In this market, apply early. If you can get any information from friends who do or did work there, do. But don’t delay to get that. Because hiring managers are getting thousands of applications and they will not sift through beyond a certain point. I’ve seen a few stop accepting applications quickly in this market.

## Organization: applications

You will be applying for a lot of roles, so you want to be organized.

Recruiters use something called an "Applicant tracking system" or ATS to keep track of candidates \- you can do the same keep track of what stage you are at with each company. I used the “Applicant Tracking System” from [https://github.com/Effective-Immediately/](https://github.com/Effective-Immediately/). 
...
I would advise that you reflect and iterate - particularly on timing.
Like I said earlier, I would not recommend changing things ad hoc during the day. You have two jobs, one managing your process and the other is actually do it. So you don't want to constantly switch back into the management mode.
Reflect on what works for you and make changes when you need to.  
For example, early November this was my schedule.

![][image1]

The next month I felt I wasn't doing enough prep, because I had too many interviews. So I started putting a specific time block in interviews for, whether they happened or not. Then if they don't happen, I can do something with that time.

![][image2]

### Avoid over-scheduling, reflect on what is and isn’t working

The final iteration I had to do was I kept feeling annoyed that I hadn’t achieved goal - I set myself quite lofty targets of numbers of hours. And I wasn't hitting that number of hours. So I just reduced the number of hours per type of prep. The other problem was I hadn't built in time for breaks, e.g. 20 minutes between to go for a walk, make tea, small oversights like that. The ordering is going to vary for everybody, this is just based around what I found works for me best.
...
- Recruiter screen and behaviourals \- 
- System Design \- ordered list from Hello Interview creator’s Reddit post  
  - Hello Interview framework  
  - Exponent free peer-peer interviews \- Excalidraw  
  - Lean into what you know from systems you’ve worked on  
- Data structures and algorithms  
  - Blind 75  
  - CTCI advice \- write up on paper, type out into LC, run and debug  
  - Look for resources that work for you for patterns you’re revising  
- Pair coding \- Tom Dalling \+ [github.com/guardian/coding-exercises](http://github.com/guardian/coding-exercises)    
...
### Stress and its influence on interview performance
...
There is actually research that a live coding interview mimics Trier Social Stress Test particularly in women. Out of curiosity I just took the problem set the next day and just worked through it, and I was really happy with my solutions, I liked what I'd done and would honestly rate that code. It's a weird quirk of the process. And a good reminder to challenge yourself with more difficult problems than you expect to get.
